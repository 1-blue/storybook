...
// type
type UseScrollDirectionHandler = (time?: number) => [boolean, boolean, number];

/**
 * 2023/03/11 - 마지막 스크롤링의 방향을 알아내는 훅 - by 1-blue
...
const useScrollDirection: UseScrollDirectionHandler = (time = 50) => {
  ...
  /** 2023/03/11 - 스크롤 이벤트에 스로틀링 적용 - by 1-blue */
  const throttleScroll = throttleHelper(handleScroll, time);

  /** 2023/03/11 - 스크롤 이벤트 등록 - by 1-blue */
  useEffect(() => {
